...
import pom_pages.POM_bookahotel;
import pom_pages.POM_bookeditinarary;
import pom_pages.POM_bookingconfirm;
import pom_pages.POM_forgotpassword;
import pom_pages.POM_homepage;
import pom_pages.POM_logoutpage;
import pom_pages.POM_newuserlogin;
import pom_pages.POM_searchhotel;
import pom_pages.POM_selecthotel;
...
public class POM_manager {
	...
	public POM_bookahotel getBookHotel() {
		book = new POM_bookahotel(driver);
		return book;
	}
